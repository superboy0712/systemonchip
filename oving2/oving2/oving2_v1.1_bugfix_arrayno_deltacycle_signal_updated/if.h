...
template < class T >
class Control4Bus_if : public sc_interface {
	public:
	virtual void write (T) = 0;
};
template < class T >
class Bus4Control_if : public sc_interface {
	public:
	virtual void LightControl (T) = 0;
};
template < class T >
class Bus4Button_if : public sc_interface {
	public:
	virtual void write (T) = 0;
};
// interface for bus to access button
template < class T >
